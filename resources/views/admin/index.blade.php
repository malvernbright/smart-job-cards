    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex p-2">
                    <a href="{{ route('admin.job_cards.create') }}" class="px-4 py-2 bg-green-700 hover:bg-green-800">
                        Create JobCard
                    </a>
                </div>
            </div>
                                ...
                                <div class="flex rounded-lg h-full dark:bg-gray-800 bg-teal-400 p-6 flex-col">
                                    ...
                                    <div class="flex flex-col justify-between flex-grow">
                                        ...
                                        <a href="{{route('admin.job_card.show', $jobCard->id)}}"
                                            class="mt-3 text-black dark:text-white hover:text-blue-600 inline-flex items-center">View
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round"
